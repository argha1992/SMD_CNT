...
parser.add_argument( "-nr", "--numrings",   type=int,   default=20,     help='Number of rings (~height)'                           )
parser.add_argument( "-rs", "--ringsize",   type=int,   default=10,      help='Number of beads per ring (~circumference)'           )
parser.add_argument( "-bl", "--bondlength", type=float, default=0.3,   help='Length of one bond'                                  )
parser.add_argument( "-bf", "--bondforce",  type=float, default=1250,   help='Force constant for one bond'                         )
parser.add_argument( "-af", "--angleforce", type=float, default=350,    help='Force constant for one bond'                         )
parser.add_argument( "-bt", "--beadtype",   type=str,   default='C1',  help='Type of the regular beads'                           )
parser.add_argument( "-ft", "--functype",   type=str,   default='Q0', help='Type of the functionalization beads'                 )
parser.add_argument( "-fb", "--numfuncb",   type=int,   default=3,      help='Number of funct. bead rings at the beginning'        )
parser.add_argument( "-fe", "--numfunce",   type=int,   default=3,      help='Number of funct. bead rings at the end'              )
parser.add_argument( "-fn", "--filename",   type=str,   default='CNT',   help='Name of the output, default: generate automatically' )
